...
- `grok-cli` - xAI Grok Build CLI runtime; requires a local `grok` install (`curl -fsSL https://x.ai/cli/install.sh | bash`); default model `grok-cli/grok-build-0.1`; use `grok login` or `XAI_API_KEY`
